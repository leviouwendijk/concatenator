        ...
        struct Run: ParsableCommand {
            ...
            func run() throws {
                ...
                if isContainingContexts {
                    // write signature of autogeneration, for later overwrite prevention safety

                    // collectedContexts.append("// type: autogenerated")
                    // collectedContexts.append("// signature: concatenator")
                    ...
                    // append as singular line, to avoid double newlines
                }
                ...
                if !collectedContexts.isEmpty {
                    ...
                    let contextsURL = cfgURL.deletingLastPathComponent().appendingPathComponent("contexts.txt")
